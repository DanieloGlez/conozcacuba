    ...
    public List<HotelDto> loadAll() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            if (!idContainerHotel.contains(idHotel)) {//inserto los elementos de la primera aparicion de un identificador
                ...
                HotelFranchiseDto hotelFranchiseDto = ServicesLocator.getHotelFranchiseServices().load(resultSet.getInt("id_hotel_franchise"));
                ProvinceDto provinceDto = ServicesLocator.getProvinceServices().load(resultSet.getInt("id_province"));
                LocalizationDto localizationDto = ServicesLocator.getLocalizationServices().load(resultSet.getInt("id_hotel_franchise"));
